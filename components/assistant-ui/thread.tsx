      ...
      >
        <div className="mx-auto flex w-full max-w-(--thread-max-width) flex-1 flex-col px-4 pt-4">
          ...
          <div
            ...
            className="mb-24 flex flex-col gap-y-8 empty:hidden"
          >
          ...
          <ThreadPrimitive.ViewportFooter className="aui-thread-viewport-footer sticky bottom-0 mt-auto flex flex-col gap-2 overflow-visible bg-gradient-to-t from-background via-background/95 to-transparent pb-4 md:pb-6 pt-10">
